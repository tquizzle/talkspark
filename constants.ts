...
// Static class strings so Tailwind can detect them at build time (no dynamic interpolation)
const DEFAULT_CLASSES = {
  badge: "bg-gray-500/10 text-gray-600 dark:text-gray-400 border border-gray-500/20",
  iconBg: "bg-gray-500/10 text-gray-600 dark:text-gray-400"
};

export const CATEGORY_CLASSES: Record<string, { badge: string; iconBg: string }> = {
  "Aspirations & Skills": {
...
export const getCategoryClasses = (category: string) =>
  CATEGORY_CLASSES[category] || DEFAULT_CLASSES;